...
const Footer = () => {
  ...
  return (
    <footer className="min-h-[65vh] bg-lwb_black text-white ">
      <div className="border-b border-[#363B4780] flex flex-col lg:flex-row items-center justify-center">
        <div className="px-8 py-20 lg:py-28 md:px-20 lg:px-28 w-full lg:w-[48%]">
          <h2 className="capitalize text-[40px] leading-[52px] w-full lg:w-[95%]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 items-center justify-center w-full lg:w-[52%] px-8 md:px-20 lg:px-28 pb-20">
          <div className="flex flex-col items-center md:items-start justify-start mb-8 lg:mb-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 py-8 lg:py-14 px-8 md:px-20 lg:px-28 gap-20 items-start justify-center">
        {/* Brand */}
        <div>
        ...
        {/* Quick Links */}
        <ul className="space-y-5 pl-0 lg:pl-14 text-[#8C94A3]">
